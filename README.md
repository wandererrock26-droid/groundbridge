...
│  > mission                                                   │
│  Mission Planner → MAVLink → CRSF / SBUS → машина            │
│  > platforms                                                 │
│  Raspberry Pi 5 · Raspberry Pi 4 · Radxa ROCK 5C             │
│  > status                                                    │
│  ● v2.2 — RELEASED — LINK SECURE                             │
└──────────────────────────────────────────────────────────────┘
```
...
и отдаёт его на борт по CRSF — либо работает прозрачным мостом к полётному
контроллеру по USB. Плюс FPV-видео по RTSP и веб-панель, из которой
настраивается всё остальное.
...
| **Режимы** | виртуальный борт для машин с ESP32 · прозрачный мост к полётному контроллеру |
